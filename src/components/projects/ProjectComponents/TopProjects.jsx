            ...
            <div className='row text-center'>
                {
                    users.sort(sortFunction).map((curr) => {
                        if(curr.name === 'Project-Showcase' || curr.name === 'Car-sale-and-usage-analysis' || curr.name === 'Bennett-Bulletin'){
                            return (<div className="col-10 col-lg-4 col-md-6 col-sm-12 mt-5 gridder myStyle" key={ curr.id }>
                                <div className="card card-prop">

                                    <Button variant="light"  className="collapse-colour" onMouseEnter={() => setOpen(!open)} onMouseLeave={() => setOpen(!open)} aria-controls="example-collapse-text" aria-expanded={open}>
                                        ...
                                        <a target="_blank" rel="noopener noreferrer" href={`https://github.com/UtkarshVijayvergia/${curr.name}/`}>
                                            <div className="d-flex align-items-center imagesizer_outer">
                                            {
                                                ...
                                                <img src={require(`../images/sample.jpg`)} alt={curr.name} className="rounded " width="100%" height="auto" ></img>
                                                :
                                        ...
                                        <div className="d-flex">
                                            <div className="ml-3 w-100">
                                                <a id='alink' target="_blank" rel="noopener noreferrer" href={`https://github.com/UtkarshVijayvergia/${curr.name}/`}>
                                                    {
                                                        (props.ScreenWidth<=1400 &&  curr.name !== 'Project-Showcase' && curr.name !== 'Bennett-Bulletin')?
